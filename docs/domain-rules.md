...
- Um controle individual novo inclui todas as vacas que estavam `LACTATING` e em lote de ordenha naquela data. A interface principal usa importação e revisão de transcrição; não há formulário manual concorrente.
