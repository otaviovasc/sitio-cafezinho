...
export function AnimalCycleSection({ data, onChangeStatus, onRegisterReproductiveEvent, onEditReproductiveEvent, onUndoStatus, onRemoveReproductiveEvent }: AnimalCycleSectionProps) {
