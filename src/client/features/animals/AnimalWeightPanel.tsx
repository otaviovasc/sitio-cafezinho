...
import { Badge, ScrollArea, SectionCard } from '../../components/ui';
...
export function AnimalWeightPanel({ weights }: { weights: AnimalWeight[] }) {
  ...
  return <SectionCard title="Histórico de pesagens" icon={Scale} className="lg:col-span-2">
    ...
    {!weights.length ? <p className="text-sm text-[var(--muted)]">Nenhuma pesagem registrada.</p> : <ScrollArea label="Histórico de pesagens">{weights.map((row) => {
